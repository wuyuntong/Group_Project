...
tree <- rpart(death_rate~., data = all, control = rpart.control(cp = 0.02))
...
```{r, echo = FALSE}
rpart.plot(tree, main = "Regreesion tree for overall data")
rpart.plot(tree1, main = "Regression tree for Cluster 1 -- ")
rpart.plot(tree2)
rpart.plot(tree3)
rpart.plot(tree4)
```
