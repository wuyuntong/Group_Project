...
cases_f_cl1 <- cases_f[cases_f$Cluster == 1,]
cases_f_cl2 <- cases_f[cases_f$Cluster == 2,]
cases_f_cl3 <- cases_f[cases_f$Cluster == 3,]
cases_f_cl4 <- cases_f[cases_f$Cluster == 4,]
clusters <- list(cases_f_cl1, cases_f_cl2, cases_f_cl3, cases_f_cl4)
