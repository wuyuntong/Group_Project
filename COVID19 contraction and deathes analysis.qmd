...
5.Unify the "countyFIPS" in health with other tables. Select the required columns from health. Then rename them and convert the data into numbers. To make the calculation easier, multiply "APrimary care" by 10000 and handle the missing values.
