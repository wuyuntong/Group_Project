...
required_packages <- c("caret", "tibble", "rpart", "rpart.plot", "cowplot", "sringr", "factoextra", "hopkins", "forecast", "lubridate", "tseries", "moments")
...
As we can see from the charts below, the number of cases continues to increase across the country. The growth rate was fastest from 2020-10 to 2021-01. Then the growth rate gradually declined after 2021-01, but the cumulative number of cases still showed an obvious upward trend. The number of new cases has increased sharply since 2020-10, peaking in 2020-12 and then declining rapidly. From the state level, the peaks of new cases basically occur between 2020-10 and 2021-01. 

At the same time, the number of deaths nationwide has also shown a continuous growth trend, with the fastest growth from 2020-11 to 2021-02. Compared to the number of cases, there is a delay of about a month. Similarly, the number of new deaths peaked in 2021-01 and then showed a clear downward trend.
...
Next we aim to identify the specific trends in cases and deaths across various regions in the United States over a certain period. We have selected the daily cumulative data from July 31, 2020, to June 30, 2021.
